      ...
      <div className="orbit-stage">
        ...
        <svg className="orbit-svg" viewBox="0 0 900 900" xmlns="http://www.w3.org/2000/svg">
          ...
          <g className="satellite-orbit-rig">
            <g transform="scale(1.35) rotate(-15)">
              <defs>
              ...
              <g transform="translate(-118 -20)">
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <line key={i} x1={i * 15.6} y1="0" x2={i * 15.6} y2="42" stroke="#4d6ea3" strokeWidth="0.6" />
                ))}
              ...
              {/* main body: gold multi-layer insulation block */}
              ...
              {/* crinkle lines suggesting foil texture */}
              {[-16, -8, 0, 8, 16].map((y, i) => (
